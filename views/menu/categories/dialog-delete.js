...
export const component = {
    ...
    template: /*html*/`
        <d-dialog
            ...
            <p class="px-4 pb-4">¿Está seguro que desea eliminar la categoría <b>{{record.name}}</b>?</p>
        </d-dialog>
    `,
    setup(props, { emit }) {
        const app = appStore();
        ...
        function callback() {
            ...
            return request({
                ...
                app.setSnackbar({text: 'Categoría eliminada correctamente.', template: '<success>'});
                return r;
            }).finally(() => {
                loading.value = false;
            });
